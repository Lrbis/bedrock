...
def _vpn_product_link(product_url, entrypoint, button_text, class_name=None, optional_parameters=None, optional_attributes=None):
...
def vpn_sign_in_link(ctx, entrypoint, button_text, class_name=None, optional_parameters=None, optional_attributes=None):
    """
    ...
    return _vpn_product_link(product_url, entrypoint, button_text, class_name, optional_parameters, optional_attributes)


@library.global_function
@jinja2.contextfunction
def vpn_subscribe_link(ctx, entrypoint, button_text, class_name=None, optional_parameters=None, optional_attributes=None):
    """
